        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          {form.id && (
            <button
              ...
              style={{ background:'#6b21a8', color:'#fff', border:'none', borderRadius:8, padding:'11px 16px', cursor:'pointer', fontSize:13, fontWeight:700, fontFamily:'inherit', width:'100%', display:'flex', alignItems:'center', justifyContent:'space-between', marginTop:4 }}
            >
